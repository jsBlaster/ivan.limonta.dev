...
function simulateRandomMouseMove() {
  ...
  var currentX = pointers[0].x || canvas.width / 2;
  var currentY = pointers[0].y || canvas.height / 2;
  var steps = 50 + Math.random() * 50;
  var currentStep = 0;
  ...
  function animateStep() {
    if (currentStep < steps) {
      ...
      var x = currentX + (targetX - currentX) * easeProgress;
      var y = currentY + (targetY - currentY) * easeProgress;
